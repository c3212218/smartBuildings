...
TCP_PORT = 5010             # Define the TCP Port
BUFFER_SIZE = 500
...
class Smoke:
    id = 501                                      # Initialize sensor id
    value = 1.00                                # Initialize sensor value
    postcode = 2100                             # Initialize sensor postcode
...
# sensors 800-1000 are Garbage sensors
      ...
      if(sensor.id==601):                           # Reset the sensor id and postcode when it reaches 100 sensors
            sensor.id = 501                           # Reset sensor id
            sensor.postcode = 2100                  # Reset sensor postcode
s.close()
