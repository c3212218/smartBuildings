...
class Luminosity:
    ...
    location = 701                             # Initialize sensor location
...
# sensors 800-1000 are Garbage sensors
      ...
      if(sensor.id==801):                           # Reset the sensor id and location when it reaches 100 sensors
            sensor.id = 901                           # Reset sensor id
            sensor.location = 701                  # Reset sensor location
s.close()
