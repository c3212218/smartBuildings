...
TCP_PORT = 5008             # Define the TCP Port
BUFFER_SIZE = 500
...
# sensors 800-1000 are Garbage sensors
      ...
      if(sensor.id==401):                           # Reset the sensor id and postcode when it reaches 100 sensors
            sensor.id = 301                           # Reset sensor id
