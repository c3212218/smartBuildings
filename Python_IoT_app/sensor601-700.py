...
class Luminosity:
    ...
    location = 601                             # Initialize sensor location
...
# sensors 800-1000 are Garbage sensors
      ...
      if(sensor.id==701):                           # Reset the sensor id and location when it reaches 100 sensors
            sensor.id = 601                           # Reset sensor id
            sensor.location = 601                  # Reset sensor location
s.close()
