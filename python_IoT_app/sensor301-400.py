...
class Smoke:
    ...
    location = 301                             # Initialize sensor location
...
# sensors 800-1000 are Garbage sensors
      ...
      if(sensor.id==401):                           # Reset the sensor id and location when it reaches 100 sensors
            sensor.id = 301                           # Reset sensor id
            sensor.location = 301                  # Reset sensor location
s.close()
