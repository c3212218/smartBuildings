...
class Smoke:
    ...
    location = 501                             # Initialize sensor location
...
# sensors 800-1000 are Garbage sensors
      ...
      if(sensor.id==601):                           # Reset the sensor id and location when it reaches 100 sensors
            sensor.id = 501                           # Reset sensor id
            sensor.location = 501                  # Reset sensor location
s.close()
